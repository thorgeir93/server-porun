function querys() {
  ...
  var create = 'CREATE TABLE GRIPIR
                (
  ...
  var drop_kynbotamat = 
    ' BEGIN
        EXECUTE IMMEDIATE "DROP TABLE KYNBOTAMAT;";
      EXCEPTION
        WHEN OTHERS THEN
          IF SQLCODE != -942 THEN
            RAISE;
  ...
  return {
    ...
    drop_gipir: drop_gipir,
    drop_kynbotamat:drop_kynbotamat
  };
}

module.exports.buildDB = querys;